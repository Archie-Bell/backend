...
from database.controllers.formController import fetch_pending_person, submit_form, fetch_pending_list, delete_collection_data
...
urlpatterns = [
    path('missing-persons/pending', fetch_pending_list, name='get_missing_persons'),
    path('missing-person/pending/<str:person_id>/', fetch_pending_person, name='get_missing_person'),
    path('missing-person/submit/', submit_form, name='submit_form'),
